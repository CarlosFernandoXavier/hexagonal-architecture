...
import com.unisinos.sistema.adapter.outbound.builder.StockItemBuilder;
...
public class ItemEstoqueMapper {
    ...
    public static List<ItemEstoque> mapToResponseList(List<ItemEstoqueEntity> itemEntities) {
        if (ObjectUtils.isEmpty(itemEntities)) return Collections.emptyList();
